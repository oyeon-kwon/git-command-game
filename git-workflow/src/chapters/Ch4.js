...
function Ch4 (props) {
  ...
  return (
    ...
    currentStep === 1
      ? <>
        <img src={ch4_1} className='show_commit' />
        <Remote />
        <Local localStatus='true' />
      </>
      : currentStep === 2
        ? <>
          <img src={ch4_2_1} className='show_commit' />
          <img src={ch4_2_2} className='show_commit' />
          <Remote />
          <Local localStatus='true' />
        </>
        : currentStep === 3
          ...
          : currentStep === 4
            ...
            : currentStep === 5
              ? <>
                <img src={ch4_5_1} />
                <img src={ch4_5_2} className='show_commit' />
                <Remote />
                <Local localStatus='true' />
                </>
              : currentStep === 6
                ? <>
                  <img src={ch4_6_1} />
                  <img src={ch4_6_2} className='show_commit' />
                  <Remote />
                  <Local localStatus='true' />
                  </>
                : null
